...
readonly ROOT_DIR
readonly SCHEME="HandySwitch"
readonly APP_BUNDLE="HandySwitch"
readonly ASSET_STEM="HandySwitch"
readonly REPO="x0c/HandySwitch"
readonly REPO_WEB="https://github.com/${REPO}"
readonly FEED_URL="https://raw.githubusercontent.com/${REPO}/main/appcast.xml"
readonly CASK_NAME="handy-switch"
...
sparkle_public_key="$(/usr/libexec/PlistBuddy -c 'Print :SUPublicEDKey' HandySwitch/Info.plist 2>/dev/null || true)"
...
if git -C "${tap_dir}" diff --cached --quiet; then
  ...
  git -C "${tap_dir}" -c core.hooksPath=/dev/null commit -m "handy-switch ${version}"
